...
export class CookieService {
  ...
  /**
   * Returns the cookie value by name (decoded). Values are stored encoded to support ; and = in content.
  ...
  /**
   * Creates/sets the cookie. Value is encoded so ; and = in content do not break the cookie.
